sap.ui.define(
  ...
  function (Control, Button, Image, Link, Text) {
    ...
    var Book = Control.extend("com.ibm.md.controls.Book", {
      // the control API:
      metadata: {
        properties: {
    ...
    //overwrite setter
    com.ibm.md.controls.Book.prototype.setCoverPictureUrl = function (sVal) {
      if (sVal) {
    ...
    com.ibm.md.controls.Book.prototype.exit = function () {
